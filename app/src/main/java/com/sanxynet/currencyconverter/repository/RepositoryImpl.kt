...
import com.sanxynet.currencyconverter.BuildConfig
import com.sanxynet.currencyconverter.api.RatesResult
...
import com.sanxynet.currencyconverter.models.realm.RatesRealm
...
@Singleton
open class RepositoryImpl @Inject constructor(val realmDb: Realm, val ratesService: RatesService) :
    IRepository {
